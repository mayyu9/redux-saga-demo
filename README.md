...
this is a sample project which is created using create-react-app. in this app i am using redux for state management and sagas to get data asynchronously
from dog.ceo/api. from this site i am fetching the images of dogs randomly. the same random dog is shown in the UI.
